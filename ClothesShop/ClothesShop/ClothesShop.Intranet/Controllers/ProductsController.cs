...
namespace ClothesShop.Intranet.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var clothesShopContext = _context.Product.Include(p => p.Category);
        ...
        public async Task<IActionResult> Create([Bind("ProductId,Name,Price,ImageNameUrl,Description,IsActive,Color,CategoryId")] Product product)
        {
